  ...
  return (
    <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow">
      ...
      <p className="text-center mb-12 text-xl font-normal text-gray-500 dark:text-gray-200">
        ...
        itaque nobis, et amet delectus. Odit eligendi sunt praesentium in
        debitis voluptatibus neque harum totam ratione. Eligendi, quibusdam
        quae! Aperiam!
      </p>
      <div className="flex justify-center items-center flex-col md:flex-row justify evenly">
        ...
        <div className="p-4 ">
          <div className="text-center mb-4 opacity-90">
            <a href="#" className="block relative">
              <img
                src="https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortCurly&accessoriesType=Wayfarers&hairColor=SilverGray&facialHairType=BeardMedium&facialHairColor=Red&clotheType=CollarSweater&clotheColor=PastelGreen&eyeType=Hearts&eyebrowType=UnibrowNatural&mouthType=Smile&skinColor=Pale"
                className="mx-auto object-cover rounded-full h-40 w-40 "
              />
            </a>
          </div>
        ...
        <div className="p-4">
          <div className="text-center mb-4 opacity-90">
            <a href="#" className="block relative">
              <img
                src="https://avataaars.io/?avatarStyle=Circle&topType=ShortHairSides&accessoriesType=Wayfarers&hairColor=Auburn&facialHairType=BeardLight&facialHairColor=Black&clotheType=BlazerSweater&eyeType=Happy&eyebrowType=FlatNatural&mouthType=Eating&skinColor=Tanned"
                className="mx-auto object-cover rounded-full h-40 w-40 "
              />
            </a>
          </div>
